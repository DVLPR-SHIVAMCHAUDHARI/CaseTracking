...
class ReceiveCaseScreenAdmin extends StatefulWidget {
  const ReceiveCaseScreenAdmin({super.key});

  @override
  State<ReceiveCaseScreenAdmin> createState() => _ReceiveCaseScreenAdminState();
}

class _ReceiveCaseScreenAdminState extends State<ReceiveCaseScreenAdmin> {
  ...
  void receiveCases() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text(
          '${receivedCases.length} cases received on $dateStr at $timeStr (${locationController.text})',
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Receive Cases (Admin)'),
